...
def main():
    ...
    model_pool = 'results/fix_k/origin/k12/usrnet/models'  # fixed
    testsets = 'testsets'     # fixed
    results = 'results_test/fix_k/k12'       # fixed
    ...
    # ----------------------------------------
    if 'G' in model_name:
        model = net(n_iter=12, h_nc=32, in_nc=4, out_nc=3, nc=[16, 32, 64, 64],
